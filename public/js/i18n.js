...
const I18N = {
  'ko': {
    ...
    'gen.intro.s2.p1':'• 주파수 슬라이더 / 다이얼 / 키패드 입력\n• 4가지 파형: 사인, 사각, 삼각, 톱니\n• 하모닉스 (배음 추가)\n• 바이노럴 비트 (좌우 채널 분리)\n• 듀얼 톤 (두 주파수 동시 재생)\n• L/R 밸런스 슬라이더 — 좌·우 채널 비율 실시간 조절 (NEW v4.1)\n• WAV 파일 내보내기 (밸런스 반영)\n• 프리셋 저장/불러오기\n• 오실로스코프 실시간 시각화',
  ...
  'en': {
    ...
    'gen.intro.tag':'Introduction · Quick Manual · v4.1',
