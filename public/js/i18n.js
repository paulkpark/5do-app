...
const I18N = {
  'ko': {
    ...
    'gen.balance':'L / R 밸런스', 'menu.logout':'로그아웃',
    ...
    'pl.empty':'플레이리스트가 없어요.<br>+ New 로 만들어보세요.',
    'pl.emptyTracks':'트랙이 없어요.<br>"현재 트랙 추가" 버튼으로 추가하세요.',
    'pl.confirmDelete':'삭제할까요?', 'pl.renamePrompt':'새 이름',
    'pl.namePrompt':'플레이리스트 이름', 'pl.trackRemoved':'트랙 제거됨',
    'pl.stopped':'■ 정지', 'pl.noCurrent':'재생 중인 트랙이 없어요',
    'pl.already':'이미 추가된 트랙이에요', 'pl.addedTo':'에 추가됨',
    'pl.untitled':'트랙', 'pl.imported':'개 가져옴', 'pl.badFile':'파일 형식 오류',
    'pl.saved':'저장됨', 'pl.shuffleOn':'셔플 켜짐', 'pl.shuffleOff':'셔플 꺼짐',
    'pl.loopOff':'반복 끔', 'pl.loopOne':'한 곡 반복', 'pl.loopAll':'전체 반복',
    'pl.trackCount':'곡', 'pl.back':'← 목록',
    'qtxab.title':'QTX 모드 — 직접 들어보기',
    'qtxab.sub':'동일한 데모 트랙을 Normal ↔ QTX 버전으로 8초씩 번갈아 재생합니다. 이어폰으로 들으면 저역 공진 대역의 차이가 뚜렷하게 느껴져요.',
    'qtxab.normalDesc':'5 kHz 저역 통과', 'qtxab.normalUse':'일반 오디오 기기용',
    'qtxab.qtxDesc':'전대역 PEMF 보존', 'qtxab.qtxUse':'스칼라 공진 대역 증폭',
    'qtxab.idle':'대기 중', 'qtxab.start':'▶ 듣고 비교하기', 'qtxab.stop':'■ 비교 중지',
    'qtxab.loading':'▶ 데모 트랙 로딩 중…', 'qtxab.loadingShort':'데모 트랙 로딩 중…',
    'qtxab.notFound':'⚠ 데모 트랙을 찾을 수 없음', 'qtxab.loadFailed':'⚠ 데모 트랙 로딩 실패',
    'qtxab.playingNormal':'▶ NORMAL 재생 중', 'qtxab.playingQtx':'▶ QTX 재생 중',
    'qtxab.demoPrefix':'데모 · ',
    'qtxab.errQtx':'⚠ 데모 트랙의 QTX 버전을 불러올 수 없습니다 — 다시 시도해 주세요',
    'qtxab.errNormal':'⚠ 데모 트랙을 불러올 수 없습니다 — 다시 시도해 주세요',
    'qtxab.errPerm':'⚠ 재생 권한이 필요합니다 — 다시 탭해 주세요',
    'qtxab.errLib':'⚠ 라이브러리 로딩 실패 — 잠시 후 다시 시도해 주세요',
    'qtxab.switchIn':'초 후 전환', 'qtxab.switching':'전환 중…',
    'qtxab.footPre':'QTX 모드는 ', 'qtxab.footBand':'0.1~1 kHz의 PEMF 대역',
    'qtxab.footPost':'과 스칼라 공진 주파수를 보존합니다. 전용 하드웨어(Quantum Torus X)와 결합할 때 바이오 레조넌스 효과가 극대화됩니다.',
    'qtxab.product':'🔷 Quantum Torus X 자세히 보기 →',
  ...
  'en': {
    ...
    'gen.balance':'L / R Balance', 'menu.logout':'Log out',
    ...
    'pl.empty':'No playlists yet.<br>Tap + New to make one.',
    'pl.emptyTracks':'No tracks yet.<br>Use "Add Current Track" to add one.',
    'pl.confirmDelete':'Delete this?', 'pl.renamePrompt':'New name',
    'pl.namePrompt':'Playlist name', 'pl.trackRemoved':'Track removed',
    'pl.stopped':'■ Stopped', 'pl.noCurrent':'Nothing is playing',
    'pl.already':'Already in this playlist', 'pl.addedTo':' — added',
    'pl.untitled':'Track', 'pl.imported':' imported', 'pl.badFile':'Unrecognised file',
    'pl.saved':'Saved', 'pl.shuffleOn':'Shuffle on', 'pl.shuffleOff':'Shuffle off',
    'pl.loopOff':'Repeat off', 'pl.loopOne':'Repeat one', 'pl.loopAll':'Repeat all',
    'pl.trackCount':' tracks', 'pl.back':'← Back',
    'qtxab.title':'QTX mode — hear it yourself',
    'qtxab.sub':'The same demo track, alternating between the Normal and QTX versions every 8 seconds. On earphones the difference in the low resonance band is easy to hear.',
    'qtxab.normalDesc':'5 kHz low-pass', 'qtxab.normalUse':'For ordinary audio gear',
    'qtxab.qtxDesc':'Full-band PEMF preserved', 'qtxab.qtxUse':'Scalar resonance band lifted',
    'qtxab.idle':'Ready', 'qtxab.start':'▶ Listen and compare', 'qtxab.stop':'■ Stop comparing',
    'qtxab.loading':'▶ Loading demo track…', 'qtxab.loadingShort':'Loading demo track…',
    'qtxab.notFound':'⚠ Demo track not found', 'qtxab.loadFailed':'⚠ Demo track failed to load',
    'qtxab.playingNormal':'▶ Playing NORMAL', 'qtxab.playingQtx':'▶ Playing QTX',
    'qtxab.demoPrefix':'Demo · ',
    'qtxab.errQtx':'⚠ Could not load the QTX version of the demo track — please try again',
    'qtxab.errNormal':'⚠ Could not load the demo track — please try again',
    'qtxab.errPerm':'⚠ Playback permission needed — tap again',
    'qtxab.errLib':'⚠ Library failed to load — please try again shortly',
    'qtxab.switchIn':'s to switch', 'qtxab.switching':'Switching…',
    'qtxab.footPre':'QTX mode preserves the ', 'qtxab.footBand':'0.1–1 kHz PEMF band',
    'qtxab.footPost':' and the scalar resonance frequencies. Paired with the Quantum Torus X hardware, the resonance experience is at its fullest.',
    'qtxab.product':'🔷 About Quantum Torus X →',
...
function applyLang() {
  ...
  // The A/B modal's status, button and countdown are driven by its engine; the
  // data-i18n sweep above just reset them to their idle markup defaults.
  if (typeof window._repaintQtxAb === 'function') { try { window._repaintQtxAb(); } catch (_) {} }
}
