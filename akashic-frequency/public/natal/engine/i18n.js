...
export const UI = {
  ko: {
    ...
    savePdf: 'PDF 저장', savingPdf: 'PDF 만드는 중…', pdfFailed: 'PDF 생성에 실패했습니다. 다시 시도해 주세요.',
    pdfEmpty: '먼저 해석을 한 개 이상 생성해 주세요.',
  ...
  en: {
    ...
    savePdf: 'Save PDF', savingPdf: 'Building PDF…', pdfFailed: 'Could not create the PDF. Please try again.',
    pdfEmpty: 'Generate at least one section first.',
